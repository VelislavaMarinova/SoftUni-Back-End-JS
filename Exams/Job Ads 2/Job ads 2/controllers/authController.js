...
authController.post('/register', isGuest(),
    body('email')
        ...
        .matches(/^[A-Za-z\@\.]+$/).withMessage('Email can only contain English letters.'),
    body('password')
        .isLength({ min: 5 }).withMessage('Password must be at least 5 characters long!'),
    body('skills')
        .isLength({ max: 40 }).withMessage('Description of skills should be a maximum of 40 characters long'),
